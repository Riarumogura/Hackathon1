...
float [] volume = {
  0.8f, 0.5f, 0.8f, 0.5f, 0.8f, 0.5f, 0.8f, 0.5f,
  0.9f, 0.3f, 0.9f, 0.3f, 1.0f,
  0.8f, 0.5f, 0.8f, 0.5f, 0.8f, 0.5f, 0.8f, 0.5f,
  0.9f, 0.3f, 0.9f, 0.3f, 1.0f,
};
...
void playSong() {
  ...
  for (int i = 0; i < melody.length; i++) {
    out.playNote(startTime[i], duration[i], new HackInstrument(Frequency.ofPitch(melody[i]).asHz(), volume[i], currentWaveform));
  }
  out.resumeNotes();
}
